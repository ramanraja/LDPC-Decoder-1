...
public class Gallager extends Generator
{
	 ...
	 * Number of rows in H will be computed as : (_cols*_colwt)/_rowwt
 	 */
	public void init (int _cols, int _colwt, int _rowwt)
	{
	...
	private void shuffle(int startingBlock, int[] col_weight)
	{
		int L = cols/rowwt;        // the block size; note: rows = L*colwt
